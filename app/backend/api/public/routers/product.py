...
from app.backend.api.public.routers.auth import get_current_user, get_current_user_optional
from app.backend.core.errors import raise_error
from app.backend.db.session import get_db
from app.backend.models.user import User
from app.backend.schemas.common import APIResponse
from app.backend.schemas.product import ProductAuditUpdate, ProductCreate, ProductOut, ProductUpdate
from app.backend.services import product as product_service
